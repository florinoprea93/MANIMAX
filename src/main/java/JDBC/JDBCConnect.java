...
public class JDBCConnect {
    ...
    public JDBCConnect(String url, String user, String pass) {
        try {
    ...
    public int execute_update(JDBCConnect con, String query) {
    ...
    public ResultSet execute_query(JDBCConnect con, String query) {
