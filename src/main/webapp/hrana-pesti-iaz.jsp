...
<html>
    <head>
        ...
        <title>Hrana pentru pestii de iaz</title>
    </head>
    <body>
        <div id="header">
        ...
        <div id="container">
            ...
            <div id="right-container">
                ...
                <h1 id="cont-title">Hrana pentru pestii de iaz</h1>
                <hr>
                ...
                <sql:query dataSource="${snapshot}" var="result">
                    SELECT P.nume_p,P.pret_unitar,P.img_url,P.id_p,P.descriere
                        ...
                        AND (P.id_cat = C.id_cat)AND(C.nume_categorie = 'Hrana pentru pestii de iaz') ;
                </sql:query>
