    ...
    <body>
        ...
        <div id="add-cart">
            ...
            <center>
                                    ...
                                    <p style="color: black; font-size:12px;font-weight: bold;font-family: 'Arial';text-indent: 20px;">
                                        <%
                                            ...
                                            while (itr2.hasNext()) {
                                                ...
                                                pageContext.setAttribute("nrprod", me.getValue());//iau cantitatea din fiecare produs
                                                if (me.getKey().equals(pageContext.getAttribute("idp").toString())) {
                                                    pageContext.setAttribute("cant", me.getValue());
                                                
                                        %>

                                        <c:set var="pret" value= "${pageContext.getAttribute('cant')*row.pret_unitar}"/>
                                        <fmt:formatNumber var="pret" value="${pret - 0.0000000005}" maxFractionDigits="2"/>
                                        <c:out value="${pret}"/>

                                        <c:set var="cant_tot" value="${cant_tot + pageContext.getAttribute('nrprod')}"/> <!--cantitatea totala-->
                                        <c:set var="total" value="${total+(pret_t*pageContext.getAttribute('cant'))}"/><!--pretul total-->
                ...
                <span style="color:black;font-weight: bold;font-size: 16px;float: right;margin-right: 70px">Pret comanda:
                ...
                <%  session.setAttribute("pt", (pageContext.getAttribute("total")));
                    session.setAttribute("ct", pageContext.getAttribute("cant_tot"));
