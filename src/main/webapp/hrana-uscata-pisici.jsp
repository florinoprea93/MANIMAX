...
<html>
    <head>
        ...
        <title>Hrana uscata pentru pisici</title>
    </head>
    <body>
        <div id="header">
        ...
        <div id="container">
            ...
            <div id="right-container">
                ...
                <h1 id="cont-title">Hrana uscata pentru pisici</h1>
                <hr>
                ...
                <sql:query dataSource="${snapshot}" var="result">
                    SELECT P.nume_p,P.pret_unitar,P.img_url,P.id_p,P.descriere
                        ...
                        WHERE (P.id_a = A.id_a)AND(A.categorie_a = 'pisici')
                        AND (P.id_cat = C.id_cat)AND(C.nume_categorie = 'Hrana uscata') ;
                </sql:query>
