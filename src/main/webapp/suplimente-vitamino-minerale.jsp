...
<html>
    <head>
        ...
        <title>Suplimente vitamino-minerale</title>
    </head>
    <body>
        <div id="header">
        ...
        <div id="container">
            ...
            <div id="right-container">
                ...
                <h1 id="cont-title">Suplimente vitamino-minerale</h1>
                <hr>
                ...
                <sql:query dataSource="${snapshot}" var="result">
                    SELECT P.nume_p,P.pret_unitar,P.img_url,P.id_p,P.descriere
                        ...
                        WHERE (P.id_a = A.id_a)AND(A.categorie_a = 'reptile')
                        AND (P.id_cat = C.id_cat)AND(C.nume_categorie = 'Suplimente vitamino-minerale') ;
                </sql:query>
